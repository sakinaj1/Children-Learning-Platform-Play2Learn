...
export function NumbersGameScreen() {
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-green-300 via-emerald-300 to-teal-300 p-4 overflow-hidden">
      <div className="max-w-4xl mx-auto h-full flex flex-col">
        {/* Header */}
        <div className="flex justify-between items-center mb-3">
          <h1 className="text-3xl font-bold text-green-800">🔢 Numbers Game</h1>
          ...
          <Card className="p-6 h-full flex flex-col shadow-2xl">
            <div className="flex-1 flex flex-col justify-center">
              ...
              <div className="text-center mb-6">
                ...
                {currentQ.image && (
                  <div className="text-8xl mb-4">{currentQ.image}</div>
                )}
              </div>
